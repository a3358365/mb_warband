...
# DWG
  ["npc17","Geoffrey","Geoffrey", tf_hero|tf_unmoveable_in_party_window, scn_town_6_tavern|entry(1),reserved, fac_geoffrey,[itm_linen_tunic,itm_hide_boots,itm_new_mace],
   str_7|agi_7|int_11|cha_6|level(6),wp(60),knows_trade_3|
   knows_inventory_management_2|knows_riding_2,
   0x000000019d004001570b893712c8d28d00000000001dc8990000000000000000],
   ["Hareck","Constable Hareck","Constable Hareck",tf_hero, 0,reserved,  fac_commoners,[itm_leather_jacket,itm_hide_boots],def_attrib|level(5),wp(20),knows_common,0x00000000000c41c001fb15234eb6dd3f],
  ["new_troop","new_troop","new_troops",tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_helmet,no_scene,reserved,fac_commoners,[itm_sword_medieval_a,itm_fighting_axe,itm_leather_jerkin,itm_skullcap,itm_hide_boots],str_9|agi_9|level(4),wp(80),knows_common,mercenary_face_1,mercenary_face_2],
# DWG
